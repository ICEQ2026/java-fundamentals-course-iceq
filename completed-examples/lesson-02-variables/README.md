...
Esta carpeta contiene una solución completa para la lección 02. Debe usarse después de intentar la práctica con el material de `starter-files/lesson-02-variables`.

| Elemento | Detalle |
|---|---|
| Tema | String, int, double, boolean y concatenación |
| Producto | Ficha de estudiante |
