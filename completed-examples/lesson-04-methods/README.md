...
Esta carpeta contiene una solución completa para la lección 04. Debe usarse después de intentar la práctica con el material de `starter-files/lesson-04-methods`.

| Elemento | Detalle |
|---|---|
| Tema | métodos, parámetros, return y Scanner |
| Producto | Calculadora simple |
