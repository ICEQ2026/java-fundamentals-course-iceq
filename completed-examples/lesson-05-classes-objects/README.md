...
Esta carpeta contiene una solución completa para la lección 05. Debe usarse después de intentar la práctica con el material de `starter-files/lesson-05-classes-objects`.

| Elemento | Detalle |
|---|---|
| Tema | clases, objetos, atributos privados, constructores, new y métodos |
| Producto | Modelo simple con jugadores y sala de práctica |
...
5. Explica qué línea produjo el cambio.
...
Esta solución no reemplaza la teoría ni el quiz. Sirve como referencia técnica para confirmar que la práctica quedó completa.
