...
Esta carpeta contiene una solución completa para la lección 01. Debe usarse después de intentar la práctica con el material de `starter-files/lesson-01-hello-world`.

| Elemento | Detalle |
|---|---|
| Tema | estructura mínima, método main y salida con System.out.println |
| Producto | Mensaje en consola |
