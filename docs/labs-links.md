...
OnlineGDB es la herramienta principal para todas las prácticas.

| Lección | Editor Online (Código Inicial) | Solución Completa |
|---|---|---|
| 01 | [Abrir Editor](https://onlinegdb.com/MSGkbKeOb) | [Ver Solución](https://onlinegdb.com/H6-MG2_jr) |
...
Cada lección tiene dos enlaces: uno para comenzar la práctica desde la plantilla inicial (Código Inicial) y otro para revisar la solución completa una vez hayas intentado resolver el laboratorio por tu cuenta.
